    ...
    def run(self, ):
        ...
        while True:
            ...
            for i in range(len(MENU_OPTION)):
                if i == menu_option:
                    self.menu_text(20, MENU_OPTION[i], COLOR_YELLOW,((WIN_WIDTH / 2), 200 + 25 * i))  # NOmeio do exixo X na altura de 70
                else:
                    self.menu_text(20, MENU_OPTION[i], COLOR_WHITE, ((WIN_WIDTH / 2), 200 + 25 * i))  # NOmeio do exixo X na altura de 70
